    ...
    <section className="w-full min-h-screen bg-[#F7F6E5] overflow-hidden relative pt-[72px] pb-[72px] px-6">
      ...
      <div className="w-full relative z-[2]">
        ...
        <div className="text-center mb-14">
          <h2 className="text-[38px] leading-[1.05] tracking-[-2px] font-extrabold font-brigro text-[#36064D] min-[391px]:text-[44px]">
            Real Spoons,
            <br />
            <span className="text-[#DA4848] font-brigro">Real Joy</span>
          </h2>
        </div>
        ...
        <div className="w-full bg-white rounded-[34px] pt-[26px] pb-[26px] px-[22px] mb-7 rotate-[-5deg] relative shadow-[0_12px_30px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.8)] max-[390px]:rounded-[30px] max-[390px]:px-5 max-[390px]:py-[22px]">
          ...
          <p className="text-[16px] min-[391px]:text-[14px] italic font-nuni leading-[1.9] text-[#5F5366] font-medium mb-[26px]">
            “Honestly the creamiest yogurt I've ever had. My kids are obsessed with the Strawberry flavor!”
          </p>

          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full bg-[#76D2DB] shrink-0" />
        ...
        <div className="w-full bg-white rounded-[34px] pt-[26px] pb-[26px] px-[22px] rotate-[4deg] relative shadow-[0_12px_30px_rgba(0,0,0,0.05),inset_0_1px_0_rgba(255,255,255,0.8)] max-[390px]:rounded-[30px] max-[390px]:px-5 max-[390px]:py-[22px]">
          ...
          <div className="flex items-center gap-3">
            <div className="w-7 h-7 rounded-full bg-[#DA4848] shrink-0" />
